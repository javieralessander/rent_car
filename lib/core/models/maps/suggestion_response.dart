...
class SuggestionResponse {
  SuggestionResponse({required this.predictions, required this.status});
...
class Prediction {
  ...
  factory Prediction.fromMap(Map<String, dynamic> json) => Prediction(
    ...
    structuredFormatting: StructuredFormatting.fromMap(
  ...
  Map<String, dynamic> toMap() => {
    ...
    "matched_substrings": List<dynamic>.from(
      matchedSubstrings.map((x) => x.toMap()),
    ),
    "place_id": placeId,
    "reference": reference,
...
class MatchedSubstring {
  ...
  Map<String, dynamic> toMap() => {"length": length, "offset": offset};
}
...
class Term {
  ...
  Map<String, dynamic> toMap() => {"offset": offset, "value": value};
}
